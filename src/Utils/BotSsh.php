...
class BotSsh
{
    ...
    public function startSelenium()
    {
        ...
        $this->ssh->exec("mkdir -p /var/www/debug/Selenium/$sessionId && DISPLAY=:99 nohup java -Dwebdriver.firefox.marionette=false -Dwebdriver.server.session.timeout=99999999 -jar /var/www/drivers/selenium-server-standalone-3.8.1.jar -enablePassThrough false -timeout 99999999 &> /var/www/debug/Selenium/$sessionId/sel.log");
    }
